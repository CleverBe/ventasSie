                    ...
                    <table class="table table-unbordered table-hover mt-1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:coid(0)" class="btn btn-dark mtmobile" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="javascript:coid(0)" class="btn btn-dark" title="Eliminar">
